...
module.exports = (function () {
  ...
  var adapter = {
    ...
    registerConnection: function(connection, collections, cb) {
      ...
      // console.log('CCCOOOOOLLLLLLEEEECCCCTTTTTIIIIOOOONNNSSS:', collections)
      connections[connection.identity] = {
        db: new PouchDB(connection.identity),
    ...
    */
    ...
    find: function (connection, collection, options, cb) {
      this.connections[connection].db.get(options.docId)
        .then((x) => cb(null, x))
        .catch((err) => cb(err))
    },

    create: function (connection, collection, values, cb) {
      this.connections[connection].db.put(values)
        .then((x) => cb(null, x))
        .catch((err) => cb(err))
    },
    ...
    destroy: function (connection, collection, options, cb) {
      this.connections[connection].db.delete(options.docId, options.docRev)
        .then((x) => cb(null, x))
        .catch((err) => cb(err))
    }
